...
export const metadata: Metadata = {
  title: "À propos",
  description:
    "L'histoire de M&H Store, ses valeurs et les neuf ateliers partenaires à travers Madagascar.",
};
...
const VALUES = [
  {
    ...
    desc: "Nous fixons les prix d'achat avec chaque atelier avant la production, pas après.",
  },
  {
    icon: RiLeafLine,
    title: "Matières responsables",
    desc: "Raphia, coton, bois issus de filières locales et de replantation certifiée.",
  },
  {
    icon: RiCommunityLine,
    title: "Neuf ateliers partenaires",
    desc: "Une relation directe et durable, sans intermédiaire ni sous-traitance en cascade.",
  },
  {
    icon: RiRecycleLine,
    title: "Peu, mais bien",
    desc: "Des collections restreintes plutôt qu'un renouvellement permanent.",
  },
];
    ...
    <div>
      ...
      >
        <div className="mx-auto grid max-w-[1200px] grid-cols-1 items-center gap-10 px-5 py-16 lg:grid-cols-2 lg:px-10 lg:py-24">
          <div>
            ...
            >
              M&H Store est partie d'un constat simple : l'artisanat malgache
              est d'une richesse rare, mais trop souvent invisible en dehors de
              ses régions d'origine. Depuis 2023, nous parcourons les hauts
              plateaux et les ateliers du pays pour sélectionner des pièces qui
              méritent d'être vues, racontées et portées ailleurs.
            </p>
          </div>
          <ProductMedia
            src=""
            alt="Atelier artisanal malgache"
          ...
          {VALUES.map((v) => (
            <div key={v.title} className="text-center">
              <div
                ...
                style={{ background: "var(--sand)", color: "var(--teal)" }}
              >
                <v.icon size={20} />
              </div>
      ...
      >
        <div className="mx-auto max-w-[1200px] px-5 py-16 text-center lg:px-10">
          ...
          <h2 className="mt-2 font-display text-3xl">
            Trois personnes, neuf ateliers, un même fil
          </h2>
      ...
      <section className="mx-auto max-w-[900px] px-5 py-16 text-center lg:py-20">
        ...
        <p
          ...
          style={{ color: "var(--ink-soft)" }}
        >
          Notre signature n'est pas un simple slogan : c'est l'idée que le foyer
          que l'on construit devrait ressembler à ce que l'on est. Nous espérons
          que chaque pièce M&H Store y contribue, un objet à la fois.
        </p>
      </section>
    </div>
  );
